...
public:
    ...
    u32 faces_count() const {
        return faces_count_;
    }

    //! Get number of indexes
    u32 index_count() const {
        return faces_count_ * 3;
    }

    //! Gets size of index buffer
    u32 index_array_size() const {
        return index_count() * sizeof( u16 );
    }
    ...
    u32 vertex_array_size() const {
        return vertex_count_ * sizeof( Vertex );
    }

    //! Convert face to index
    u32 face_to_index( u32 face ) const {
        return face * 3;
    }
