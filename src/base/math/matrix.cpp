...
Matrix4::Matrix4(f32 vxx, f32 vxy, f32 vxz, f32 vxw,
...
void Matrix4::Invert() {
    ...
    det = src[0]*_matrix.array2d[0][0] + src[1]*_matrix.array2d[0][1]
        + src[2]*_matrix.array2d[0][2] + src[3]*_matrix.array2d[0][3];
    det = 1.0f / det;
...
Matrix4 Matrix4::operator * (const Matrix4 &_matrix) const {
    ...
    result.array2d[0][0] = array2d[0][0]*_matrix.array2d[0][0]
        + array2d[0][1]*_matrix.array2d[1][0]
        + array2d[0][2]*_matrix.array2d[2][0]
        + array2d[0][3]*_matrix.array2d[3][0];
    result.array2d[0][1] = array2d[0][0]*_matrix.array2d[0][1]
        + array2d[0][1]*_matrix.array2d[1][1]
        + array2d[0][2]*_matrix.array2d[2][1]
        + array2d[0][3]*_matrix.array2d[3][1];
    result.array2d[0][2] = array2d[0][0]*_matrix.array2d[0][2]
        + array2d[0][1]*_matrix.array2d[1][2]
        + array2d[0][2]*_matrix.array2d[2][2]
        + array2d[0][3]*_matrix.array2d[3][2];
    result.array2d[0][3] = array2d[0][0]*_matrix.array2d[0][3]
        + array2d[0][1]*_matrix.array2d[1][3]
        + array2d[0][2]*_matrix.array2d[2][3]
        + array2d[0][3]*_matrix.array2d[3][3];

    result.array2d[1][0] = array2d[1][0]*_matrix.array2d[0][0]
        + array2d[1][1]*_matrix.array2d[1][0]
        + array2d[1][2]*_matrix.array2d[2][0]
        + array2d[1][3]*_matrix.array2d[3][0];
    result.array2d[1][1] = array2d[1][0]*_matrix.array2d[0][1]
        + array2d[1][1]*_matrix.array2d[1][1]
        + array2d[1][2]*_matrix.array2d[2][1]
        + array2d[1][3]*_matrix.array2d[3][1];
    result.array2d[1][2] = array2d[1][0]*_matrix.array2d[0][2]
        + array2d[1][1]*_matrix.array2d[1][2]
        + array2d[1][2]*_matrix.array2d[2][2]
        + array2d[1][3]*_matrix.array2d[3][2];
    result.array2d[1][3] = array2d[1][0]*_matrix.array2d[0][3]
        + array2d[1][1]*_matrix.array2d[1][3]
        + array2d[1][2]*_matrix.array2d[2][3]
        + array2d[1][3]*_matrix.array2d[3][3];

    result.array2d[2][0] = array2d[2][0]*_matrix.array2d[0][0]
        + array2d[2][1]*_matrix.array2d[1][0]
        + array2d[2][2]*_matrix.array2d[2][0]
        + array2d[2][3]*_matrix.array2d[3][0];
    result.array2d[2][1] = array2d[2][0]*_matrix.array2d[0][1]
        + array2d[2][1]*_matrix.array2d[1][1]
        + array2d[2][2]*_matrix.array2d[2][1]
        + array2d[2][3]*_matrix.array2d[3][1];
    result.array2d[2][2] = array2d[2][0]*_matrix.array2d[0][2]
        + array2d[2][1]*_matrix.array2d[1][2]
        + array2d[2][2]*_matrix.array2d[2][2]
        + array2d[2][3]*_matrix.array2d[3][2];
    result.array2d[2][3] = array2d[2][0]*_matrix.array2d[0][3]
        + array2d[2][1]*_matrix.array2d[1][3]
        + array2d[2][2]*_matrix.array2d[2][3]
        + array2d[2][3]*_matrix.array2d[3][3];

    result.array2d[3][0] = array2d[3][0]*_matrix.array2d[0][0]
        + array2d[3][1]*_matrix.array2d[1][0]
        + array2d[3][2]*_matrix.array2d[2][0]
        + array2d[3][3]*_matrix.array2d[3][0];
    result.array2d[3][1] = array2d[3][0]*_matrix.array2d[0][1]
        + array2d[3][1]*_matrix.array2d[1][1]
        + array2d[3][2]*_matrix.array2d[2][1]
        + array2d[3][3]*_matrix.array2d[3][1];
    result.array2d[3][2] = array2d[3][0]*_matrix.array2d[0][2]
        + array2d[3][1]*_matrix.array2d[1][2]
        + array2d[3][2]*_matrix.array2d[2][2]
        + array2d[3][3]*_matrix.array2d[3][2];
    result.array2d[3][3] = array2d[3][0]*_matrix.array2d[0][3]
        + array2d[3][1]*_matrix.array2d[1][3]
        + array2d[3][2]*_matrix.array2d[2][3]
        + array2d[3][3]*_matrix.array2d[3][3];
...
Vector4 Matrix4::operator * (const Vector4 &_vector) const {
    return Vector4(
        array2d[0][0]*_vector.x + array2d[0][1]*_vector.y
            + array2d[0][2]*_vector.z + array2d[0][3]*_vector.w,
        array2d[1][0]*_vector.x + array2d[1][1]*_vector.y
            + array2d[1][2]*_vector.z + array2d[1][3]*_vector.w,
        array2d[2][0]*_vector.x + array2d[2][1]*_vector.y
            + array2d[2][2]*_vector.z + array2d[2][3]*_vector.w,
        array2d[3][0]*_vector.x + array2d[3][1]*_vector.y
            + array2d[3][2]*_vector.z + array2d[3][3]*_vector.w);
}
